...
First get the cleaned data (ttc_subway_delay.csv) from
`data_cleaning.R`. The start this pipeline.
...
Then do the following geoprocessing to obtain `ttc-station-point.csv`:
Geodatabase to Shape, Add XY Coordinates, Export Table.
